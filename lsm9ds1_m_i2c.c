...
static int lsm9ds1_m_i2c_probe(struct i2c_client *client,
                                const struct i2c_device_id *id)
{
	...
	i2c_set_clientdata(client, indio_dev);
        ...
        return lsm9ds1_m_probe(indio_dev, &client->dev);
}

static int lsm9ds1_m_i2c_remove(struct i2c_client *client)
{
	struct iio_dev *indio_dev = i2c_get_clientdata(client);

	return lsm9ds1_m_remove(indio_dev);
}
...
static struct i2c_driver lsm9ds1_m_driver = {
	...
	.probe		= lsm9ds1_m_i2c_probe,
	.remove		= lsm9ds1_m_i2c_remove,
...
MODULE_DESCRIPTION("magnetometer part of the IMU LSM9DS1 I2C driver");
MODULE_LICENSE("GPL");
