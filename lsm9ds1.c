...
#define LSM9DS1_FS_XL_SCALE_2G  IIO_G_TO_M_S_2( 2000000000ULL / S16_MAX)
#define LSM9DS1_FS_XL_SCALE_4G  IIO_G_TO_M_S_2( 4000000000ULL / S16_MAX)
#define LSM9DS1_FS_XL_SCALE_8G  IIO_G_TO_M_S_2( 8000000000ULL / S16_MAX)
#define LSM9DS1_FS_XL_SCALE_16G IIO_G_TO_M_S_2(16000000000ULL / S16_MAX)
                         ...
                         char *buf)
{
        ...
        /* struct lsm9ds1_state *st = iio_priv(indio_dev); */
        // TODO: spinlock
        int len = 0, ret;
        ...
        switch ((u8)ret & LSM9DS1_FS_XL_MASK) {
...
static ssize_t
lsm9ds1_store_accel_max_g(struct device *dev,
                                 struct device_attribute *attr,
                                 const char *buf,
                                 size_t len)
{
        ...
        case 2:
                ret = lsm9ds1_register_mask_write(
                        ...
                        LSM9DS1_FS_XL_MASK, LSM9DS1_FS_XL_2G);
                break;
        case 4:
                ret = lsm9ds1_register_mask_write(
                        data->client, LSM9DS1_REG_CTRL_REG6_XL,
                        LSM9DS1_FS_XL_MASK, LSM9DS1_FS_XL_4G);
                break;
        case 8:
                ret = lsm9ds1_register_mask_write(
                        data->client, LSM9DS1_REG_CTRL_REG6_XL,
                        LSM9DS1_FS_XL_MASK, LSM9DS1_FS_XL_8G);
                break;
        case 16:
                ret = lsm9ds1_register_mask_write(
                        data->client, LSM9DS1_REG_CTRL_REG6_XL,
                        LSM9DS1_FS_XL_MASK, LSM9DS1_FS_XL_16G);
                break;
        default:
                return -EINVAL;
        }
...
static IIO_DEVICE_ATTR(accel_max_g, S_IRUGO | S_IWUSR,
                       lsm9ds1_show_accel_max_g,
                       lsm9ds1_store_accel_max_g,
                       0);


static struct attribute *lsm9ds1_attributes[] = {
        &iio_const_attr_in_accel_max_g_available.dev_attr.attr,
        &iio_dev_attr_accel_max_g.dev_attr.attr,
        NULL,
};

static const struct attribute_group lsm9ds1_attribute_group = {
        .attrs = lsm9ds1_attributes,
};
